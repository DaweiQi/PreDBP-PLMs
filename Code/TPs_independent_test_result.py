...
# ProtT5 feature
with open("../Pre-trained_features/TPs/TPs_train_P.txt_t5.pkl", "rb") as tf:
    feature_dict = pickle.load(tf)
train_pre_P = np.array([item for item in feature_dict.values()])
with open("../Pre-trained_features/TPs/TPs_train_N.txt_t5.pkl", "rb") as tf:
    feature_dict = pickle.load(tf)
...
# PsePSSM feature
train_pse_pssm_P = pd.read_csv('../PSSM_features/TPs/TPs_train_P_pse_pssm.csv')
...
train_pse_pssm_N = pd.read_csv('../PSSM_features/TPs/TPs_train_N_pse_pssm.csv')
...
# ProtT5 feature
with open("../Pre-trained_features/TPs/TPs_independent_test_P.txt_t5.pkl", "rb") as tf:
    feature_dict = pickle.load(tf)
test_pre_P = np.array([item for item in feature_dict.values()])
print("test_pre_P:", test_pre_P.shape)
with open("../Pre-trained_features/TPs/TPs_independent_test_N.txt_t5.pkl", "rb") as tf:
    feature_dict = pickle.load(tf)
...
# PsePSSM feature
test_pse_pssm_P = pd.read_csv('../PSSM_features/TPs/TPs_test_P_pse_pssm.csv')
...
test_pse_pssm_N = pd.read_csv('../PSSM_features/TPs/TPs_test_N_pse_pssm.csv')
